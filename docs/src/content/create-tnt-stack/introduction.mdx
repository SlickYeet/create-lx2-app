...
- and most [importantly](/docs/usage/payloadcms),
  [**Payload CMS**](https://payloadcms.com/)

This stack has been gaining popularity in the web development community for its
ease of use, and developer experience. I would include performance as well, but
speed is not one of javascript's strong suits. 😅

Nevertheless, the stack is a great choice for building web applications, and
websites, thus the reason for its popularity, and the reason for creating this
tool.
