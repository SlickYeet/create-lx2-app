...
It is as simple as that. Once you have answered all the prompts, you can checkout the [First Steps](/docs/usage/first-steps) section to learn more about how to use the TNT Stack.
